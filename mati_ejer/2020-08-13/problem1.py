comm='''
Implemente en Python una jerarquia de clases para representar grafos
dirigidos y no dirigidos, determinar caminos entre vertices
, determinar cuales conjuntos de grafos conexos hay, encontrar el camino
continuo mas largo, etc.
'''
